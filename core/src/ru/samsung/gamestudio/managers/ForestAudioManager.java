...
public class ForestAudioManager {
    ...
    public ForestAudioManager() {
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal(GameResources.FOREST_MUSIC_PATH));
        wingSound = Gdx.audio.newSound(Gdx.files.internal(GameResources.WING_SOUND_PATH));
        pointSound = Gdx.audio.newSound(Gdx.files.internal(GameResources.POINT_SOUND_PATH));
        ...
        musicOn = ForestMemoryManager.loadIsMusicOn();
        soundOn = ForestMemoryManager.loadIsSoundOn();
        if (musicOn) {
