...
public final class ForestMemoryManager {
    ...
    private static final String BEST_SCORE_KEY =
            "bestScore";

    private static final String MUSIC_ON_KEY =
            "musicOn";

    private static final String SOUND_ON_KEY =
            "soundOn";
    ...
    public static int loadBestScore() {
        return getPreferences().getInteger(
                BEST_SCORE_KEY,
                0
        );
    }
